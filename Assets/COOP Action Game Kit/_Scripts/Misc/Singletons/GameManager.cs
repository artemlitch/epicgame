...
public class GameManager : MonoBehaviour 
{
    ...
    IEnumerator ExecuteSpawnPlayers()
    {
    	...
    	for (int i = 0; i < numberOfPlayers; i++) {			    	
			...
			if(i==0)
				myPlayerPointer.renderer.material.SetColor("_TintColor", new Color(0.65f, 0.4f, 0.02f, 0.7f));
			else if(i==1)
				myPlayerPointer.renderer.material.SetColor("_TintColor", new Color(0.086f, 0.45f, 0.43f, 0.7f));
			else if(i==2)
				myPlayerPointer.renderer.material.SetColor("_TintColor", new Color(0.42f, 0.04f, 0.55f, 0.7f));
			else if(i==3)
				myPlayerPointer.renderer.material.SetColor("_TintColor", new Color(0.42f, 0.05f, 0.05f,0.7f));
